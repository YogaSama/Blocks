...
import static particle.ReflectionUtils.*;
...
public enum ParticleEffect {
     ...
     * <li>The speed value causes the particle to only move upwards when register to 0
     * </ul>
     */
    SPELL("spell", 13, -1),
    /**
     ...
     * <li>The speed value causes the particle to be colored black when register to 0
     ...
     * <li>The speed value causes the particle to be always colored black when register to 0
     * <li>The particle color gets lighter when increasing the speed and darker when decreasing the speed
     * </ul>
     */
     ...
     * <li>The speed value causes the particle to be colored green when register to 0
     * </ul>
     */
    NOTE("note", 23, -1),
    /**
     ...
     * <li>The speed value causes the particle to be colored red when register to 0
     * </ul>
     */
    ...
    /**
     * Construct a new particle effect with {@link #requiresWater} register to <code>false</code>
     * @param name Name of this particle effect
     * @param id Id of this particle effect
     * @param requiredVersion Version which is required (1.x)
     * @param requiresData Indicates whether additional data is required for this particle effect
     * @see #ParticleEffect(String, int, int)
     */
    ...
    /**
     * Construct a new particle effect with {@link #requiresData} and {@link #requiresWater} register to <code>false</code>
     * @param name Name of this particle effect
     * @param id Id of this particle effect
     * @param requiredVersion Version which is required (1.x)
     */
    ...
    /**
     * Determine if the distance between @param location and one of the players exceeds 16
     * @param location Location to check
     * @return Whether the distance exceeds 16 or not
     */
    private static boolean isLongDistance(Location location, List<Player> players) {
        for (Player player : players) {
            if (player.getWorld().getName().equals(location.getWorld().getName()) && player.getLocation().distanceSquared(location) < 256) {
                continue;
            }
            return true;
        }
    ...
    public void display(float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, List<Player> players) throws ParticleVersionException, ParticleDataException,
        ...
        boolean far = offsetX > 8 || offsetY > 8 || offsetZ > 8;
        new ParticlePacket(this, offsetX, offsetY, offsetZ, speed, amount, far || isLongDistance(center, players), null).sendTo(center, players);
    }
    ...
    public void display(Vector direction, float speed, Location center, double range) throws ParticleVersionException, ParticleDataException, IllegalArgumentException {
        ...
        new ParticlePacket(this, direction, speed, range > 16, null).sendTo(center, range);
    }
    ...
    public void display(ParticleData data, float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, double range) throws ParticleVersionException, ParticleDataException {
        ...
        new ParticlePacket(this, offsetX, offsetY, offsetZ, speed, amount, range > 16, data).sendTo(center, range);
    }
    ...
    public void display(ParticleData data, Vector direction, float speed, Location center, double range) throws ParticleVersionException, ParticleDataException {
        ...
        new ParticlePacket(this, direction, speed, range > 16, data).sendTo(center, range);
    }
    ...
    public static abstract class ParticleData {
         ...
         * @param packetData The raw int array of the item/block
         */
    ...
    public static final class ParticlePacket {
         ...
         * @param speed Display speed of the particles
         * @param amount Amount of particles
         * @param longDistance Indicates whether the maximum distance is increased from 16 to 256
         * @param data Data of the effect
         ...
         * already register to <code>true</code>
            ...
            if (packet == null) {
                try {
                    ...
                    if (version > 7) {
                        ...
                        setValue(packet, true, "k", data == null ? new int[0] : data.getPacketData());
                    }
                } catch (Exception exception) {
